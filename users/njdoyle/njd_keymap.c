...
#define \
	...
	NJD_BASE_LAYOUT( \
		...
		KC_##NJD_KM_LOWER , KC_##NJD_KM_RAISE   , \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[NJD_L_LOWER] = NJD_LAYER_LAYOUT_KC( \
	...
	[NJD_L_RAISE] = NJD_LAYER_LAYOUT_KC( \
	...
	[NJD_L_FUNCTION] = NJD_LAYER_LAYOUT( \
		KC_F1, KC_F2 , KC_F3 , KC_F4 , NJD_K_OSMODE, NJD_K_QWERTY, NJD_K_DVORAK, NJD_K_COLEMAK  , NJD_K_COLEMAK_DH, NJD_K_COLEMAK_DHK, \
		KC_F5, KC_F6 , KC_F7 , KC_F8 , KC_NLCK     , KC_MRWD     , KC_VOLD     , KC_VOLU        , KC_MFFD         , KC_MPLY          , \
		KC_F9, KC_F10, KC_F11, KC_F12, KC_SLCK     , XXXXXXX     , XXXXXXX     , NJD_K_SS_WINDOW, NJD_K_SS_AREA   , NJD_K_SS_ALL     , \
